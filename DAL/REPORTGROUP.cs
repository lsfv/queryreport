...
namespace CUSTOMRP.DAL
{
    ...
    public partial class REPORTGROUP
    {
        ...
        public int Add(int UserID, CUSTOMRP.Model.REPORTGROUP model)
        {
            ...
            strSql.Append("insert into REPORTGROUP(");
            strSql.Append("DATABASEID,NAME,DESCRIPTION,AUDOTIME)");
            ...
            parameters[3].Value = model.AUDOTIME;
            ...
            else
            {
                ...
                auditobj.ModuleName = "DAL.REPORTGROUP.Add";
                auditobj.Message = String.Format(AppNum.AuditMessage.ReportGroupInsertSuccess, model.ID);
        ...
        {
            StringBuilder strSql=new StringBuilder();
            strSql.Append("update REPORTGROUP set ");
            ...
            if (rows > 0)
            {
                ...
                auditobj.CreateDate = DateTime.Now;
                auditobj.MessageType = Model.AUDITLOG.Severity.Audit;
                auditobj.ModuleName = "DAL.REPORTGROUP.Update";
                auditobj.Message = String.Format(AppNum.AuditMessage.ReportGroupUpdateSuccess, model.ID);
        ...
        public bool Delete(int UserID, int ID)
        {
            ...
            StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from REPORTGROUP ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
            ...
            if (rows > 0)
            {
                ...
                auditobj.CreateDate = DateTime.Now;
                auditobj.MessageType = Model.AUDITLOG.Severity.Audit;
                auditobj.ModuleName = "DAL.REPORTGROUP.Delete";
                auditobj.Message = String.Format(AppNum.AuditMessage.ReportGroupDeleteSuccess, ID);
        ...
        public CUSTOMRP.Model.REPORTGROUP GetModel(int UserID, int ID)
        {
            ...
            StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 ID,DATABASEID,NAME,DESCRIPTION,AUDOTIME from REPORTGROUP ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
            ...
            CUSTOMRP.Model.REPORTGROUP model=new CUSTOMRP.Model.REPORTGROUP();
        ...
        /// 得到一个对象实体
        /// </summary>
        public CUSTOMRP.Model.REPORTGROUP DataRowToModel(DataRow row)
        {
            CUSTOMRP.Model.REPORTGROUP model=new CUSTOMRP.Model.REPORTGROUP();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql=new StringBuilder();
            strSql.Append("select ID,DATABASEID,NAME,DESCRIPTION,AUDOTIME ");
            strSql.Append(" FROM REPORTGROUP ");
            if(strWhere.Trim()!="")
            {
        ...
        public DataSet GetList(int UserID, int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,DATABASEID,NAME,DESCRIPTION,AUDOTIME ");
            strSql.Append(" FROM REPORTGROUP ");
            if(strWhere.Trim()!="")
            {
                strSql.Append(" where "+strWhere);
        ...
        {
            StringBuilder strSql=new StringBuilder();
            strSql.Append("select count(1) FROM REPORTGROUP ");
            if(strWhere.Trim()!="")
            {
                strSql.Append(" where "+strWhere);
            }
        ...
        public DataSet GetListByPage(int UserID, string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from REPORTGROUP T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "REPORTGROUP";
