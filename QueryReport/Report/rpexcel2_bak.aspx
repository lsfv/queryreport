<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/mp.master" AutoEventWireup="true" CodeBehind="rpexcel2_bak.aspx.cs" Inherits="QueryReport.rpexcel2_bak" EnableViewState="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class='page-header'>
        ...
        <div class='pull-right'>
            <div class='btn-group'>
                <asp:Button ID="btnRun" runat="server" Text="Run" OnClick="btnRun_Click" CssClass="btn btn-primary" /></div>
            <div class='btn-group'>
                <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" CssClass="btn btn-primary" /></div>
            <div class='btn-group'>
                <asp:Button ID="btnBack" runat="server" Text="Query Report List" OnClick="btnBack_Click" CssClass="btn btn-primary" /></div>
        </div>
