<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/mp.master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="QueryReport.Admin.Company" %>
    ...
    <div class='col-sm-12'>
        <div class=' box bordered-box orange-border' style='margin-bottom:0;'>
            <div class='box-header blue-background'>
                <div class='title'>Company Maintanance</div>
                <div class='actions'>
                        ...
                        <tbody>
                            <asp:Repeater ID="Repeater3" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td><%# DataBinder.Eval(Container.DataItem, "STATUS").ToString()=="1"?"Active":"Inactive"%></td>
