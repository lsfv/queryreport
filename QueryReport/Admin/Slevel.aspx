<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/mp.master" AutoEventWireup="true" CodeBehind="Slevel.aspx.cs" Inherits="QueryReport.Admin.Slevel" %>
    ...
    <div class='col-sm-12'>
        <div class=' box bordered-box orange-border' style='margin-bottom:0;'>
            <div class='box-header blue-background'>
                <div class='title'>Query Security Level</div>
                <div class='actions'>
                    ...
                    <table class='data-table-column-filter table table table-bordered-th table-striped' style='margin-bottom:0;'>
                        ...
                        <tbody>
                            <asp:Repeater ID="Repeater3" runat="server">
                                <ItemTemplate>
                                <tr>
                                    <td style=" width:130px;"><%# DataBinder.Eval(Container.DataItem, "Order number")%></td>
