  ...
  this.setDataTable = function(selector) {
    if (jQuery().dataTable) {
      return selector.each(function(i, elem) {
        ...
        dt.closest('.dataTables_wrapper').find('div.dataTables_filter input[type=text]').addClass("form-control input-sm").attr('placeholder', 'Search');
        return dt.closest('.dataTables_wrapper').find('input');
    });
    }
  };
