...
namespace Function
{
    public static class IncCommon
    {
        ...
        public static string GetBuildNumber(int p_intLevel)
        {
            ...
            if (p_intLevel >= 1)
                sb.Append("v" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Major.ToString());

            if (System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Minor.ToString() != string.Empty && p_intLevel >= 2)
                sb.Append("." + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Minor.ToString());

            if (System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Build.ToString() != string.Empty && p_intLevel >= 3)
                sb.Append("." + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Build.ToString());

            if (System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Revision.ToString() != string.Empty && p_intLevel >= 4)
                sb.Append("." + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.Revision.ToString());
