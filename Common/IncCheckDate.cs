...
namespace Common // 设置项目属性可修改本项目的命名空间   
{
    /// <summary>   
    /// 页面数据校验类   
    /// 修改自 李天平先生的作品，一并感谢。   
    /// </summary>   
    public abstract class IncCheckDate
    {
        ...
        /// <returns></returns>   
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "CHZN")]
