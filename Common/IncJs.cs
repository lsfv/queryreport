...
namespace Common
{
    ...
    public abstract class JScript
    {
        ...
        /// 只是省去2边标签。
        /// </summary>
        /// <param name="selfjs"></param>
        public static void SelfJS(string selfjs)
        {
            #region
            string js = @"<Script language='JavaScript'>" + selfjs + "</Script>";
        ...
        public static void AlertAndRedirect(string message, string toURL)
        {
            ...
            HttpContext.Current.Response.Write(String.Format(CultureInfo.InvariantCulture, js, message, toURL));
            #endregion
        }
        ...
        public static void GoHistory(int value)
        {
            ...
            HttpContext.Current.Response.Write(String.Format(CultureInfo.InvariantCulture, js, value));
            #endregion
        }
        ...
        public static void JavaScriptLocationHref(string url)
        {
            ...
            js = String.Format(CultureInfo.InvariantCulture, js, url);
            HttpContext.Current.Response.Write(js);
            #endregion
        }
        ...
        {
            #region
            string features = String.Format(CultureInfo.InvariantCulture,
                "dialogWidth:{0}px;dialogHeight:{1}px;dialogLeft:{2}px;dialogTop:{3}px;center:yes;help=no;resizable:no;status:no;scroll=yes",
        ...
        public static void SelfJS(string js, Page page, string jskey)
        {
            #region
            if (!page.ClientScript.IsStartupScriptRegistered(page.GetType(), jskey))
            {
                page.ClientScript.RegisterStartupScript(page.GetType(), jskey, js);
            }
            #endregion
        }
        ...
        public static void AlertAndRedirect(string message, string toURL, Page page)
        {
            ...
            {
                page.ClientScript.RegisterStartupScript(page.GetType(), "AlertAndRedirect", String.Format(CultureInfo.InvariantCulture, js, message, toURL));
            }
            #endregion
        }
        ...
        public static void GoHistory(int value, Page page)
        {
            ...
            {
                page.ClientScript.RegisterStartupScript(page.GetType(), "GoHistory", String.Format(CultureInfo.InvariantCulture, js, value));
            }
            #endregion
        }
