...
namespace CUSTOMRP.BLL
{
    ...
    {
        private readonly CUSTOMRP.DAL.USERGROUP dal = new DAL.USERGROUP();
        ...
        /// 获得数据列表
        /// </summary>
        public List<CUSTOMRP.Model.USERGROUP> GetModelList(int UserID, string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<CUSTOMRP.Model.USERGROUP> DataTableToList(DataTable dt)
        {
            List<CUSTOMRP.Model.USERGROUP> modelList = new List<CUSTOMRP.Model.USERGROUP>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                CUSTOMRP.Model.USERGROUP model;
