...
namespace CUSTOMRP.BLL
{
    ...
    {
        private readonly CUSTOMRP.DAL.SensitivityLevel dal = new DAL.SensitivityLevel();
        ...
        /// 获得数据列表
        /// </summary>
        public List<CUSTOMRP.Model.SensitivityLevel> GetModelList(int UserID, string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<CUSTOMRP.Model.SensitivityLevel> DataTableToList(DataTable dt)
        {
            List<CUSTOMRP.Model.SensitivityLevel> modelList = new List<CUSTOMRP.Model.SensitivityLevel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                CUSTOMRP.Model.SensitivityLevel model;
